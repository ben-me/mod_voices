...
<header class='absolute w-full z-1 flex font-semibold items-center justify-between p-2 md:px-8'>
  ...
  <nav>
    <ul class='flex items-center gap-4'>
      ...
      <li>
        <a href={resolve('/voices')} class='inline-block p-2'>Synchronsprecher</a>
      </li>
      <li>
        <a
          href={resolve('/signup')}
